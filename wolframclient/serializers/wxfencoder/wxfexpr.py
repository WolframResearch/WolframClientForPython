...
class WXFExprFunction(WXFExpr):
    ...
    def __init__(self, length):
        super().__init__(WXF_CONSTANTS.Function)
        self.length = length
...
class WXFExprReal(WXFExpr):
    ...
    def __init__(self, value):
        ...
        super().__init__(WXF_CONSTANTS.Real64)
        self.value = value
...
class WXFExprSymbol(_WXFExprStringLike):
    ...
    def __init__(self, value):
        super().__init__(WXF_CONSTANTS.Symbol, value, allow_binary=True)
...
class WXFExprString(_WXFExprStringLike):
    ...
    def __init__(self, value):
        super().__init__(WXF_CONSTANTS.String, value)
...
class WXFExprBigInteger(_WXFExprStringLike):
    ...
    def __init__(self, value):
        super().__init__(WXF_CONSTANTS.BigInteger, value, allow_binary=True)
...
class WXFExprBigReal(_WXFExprStringLike):
    ...
    def __init__(self, value):
        super().__init__(WXF_CONSTANTS.BigReal, value, allow_binary=True)
...
class WXFExprBinaryString(WXFExpr):
    ...
    def __init__(self, data):
        ...
        super().__init__(WXF_CONSTANTS.BinaryString)
...
class WXFExprPackedArray(_WXFExprArray):
    ...
    def __init__(self, dimensions, value_type, data=None):
        ...
        super().__init__(WXF_CONSTANTS.PackedArray, dimensions, value_type, data)
...
class WXFExprNumericArray(_WXFExprArray):
    ...
    def __init__(self, dimensions, value_type, data=None):
        super().__init__(WXF_CONSTANTS.NumericArray, dimensions, value_type, data)
...
class WXFExprAssociation(WXFExpr):
    ...
    def __init__(self, length):
        ...
        super().__init__(WXF_CONSTANTS.Association)
        self.length = length
...
class WXFExprRule(_WXFExprRule):
    ...
    def __init__(self):
        super().__init__(WXF_CONSTANTS.Rule)
...
class WXFExprRuleDelayed(_WXFExprRule):
    ...
    def __init__(self):
        super().__init__(WXF_CONSTANTS.RuleDelayed)
