...
html_static_path = ['wri_theme/static']
...
latex_documents = [
    (master_doc, 'WolframClientLibraryForPython.tex', u'Wolfram Client Library for Python Documentation',
     u'Wolfram Research', 'manual'),
]
...
man_pages = [
    (master_doc, 'WolframClientLibraryForPython', u'Wolfram Client Library for Python Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'WolframClientLibraryForPython', u'Wolfram Client Library for Python Documentation',
     author, 'WolframClientLibraryForPython', 'Interact with Wolfram Language from Python.',
     'Miscellaneous'),
]
